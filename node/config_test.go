...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gdc.ipc", false, filepath.Join(os.TempDir(), "gdc.ipc")},
		{"data", "gdc.ipc", false, "data/gdc.ipc"},
		{"data", "./gdc.ipc", false, "./gdc.ipc"},
		{"data", "/gdc.ipc", false, "/gdc.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gdc.ipc", true, `\\.\pipe\geth.ipc`},
		{"data", "gdc.ipc", true, `\\.\pipe\geth.ipc`},
