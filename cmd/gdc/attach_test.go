...
// TestAttachWithHeaders tests that 'gdc attach' with custom headers works, i.e
...
// TestAttachWithHeaders tests that 'gdc db --remotedb' with custom headers works, i.e
// that custom headers are forwarded to the target.
