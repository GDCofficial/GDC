...
var (
	walletCommand = &cli.Command{
		...
		ArgsUsage: "",
		Description: `
    gdc wallet import /path/to/my/presale.wallet
		...
		Subcommands: []*cli.Command{
			{
				...
				Description: `
	gdc wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the password can be specified with the --password flag:
    ...
    gdc account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    gdc account import [options] <keyfile>
